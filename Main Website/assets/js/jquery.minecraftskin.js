	...
	var methods = {
		init: function(options) {
			return this.each(function(index){
				...
				// Request the data
				methods.requestData('https://s3.amazonaws.com/MinecraftSkins/'+settings.username+'.png', $this, settings);
			});
		},
		...
		requestData: function(username, $this, settings) {
			var result;
			var yql = 'https://query.yahooapis.com/v1/public/yql?q=' + encodeURIComponent('SELECT * FROM data.uri WHERE url = "' + username + '"') + '&format=json&callback=?';
